...
export async function POST(req) {
  try {
    ...
    const apiUrl = `https://api.distancematrix.ai/maps/api/distancematrix/json?origins=${locationsStr}&destinations=${locationsStr}&key=T25j0PtSSAvSqwPizdVbaFil0u6YxEDt97R9VwtL8VVmIaX6ccQVHN3joU4bUiKG`;
